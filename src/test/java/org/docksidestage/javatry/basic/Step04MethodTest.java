...
// 久保さんはどちら派ですか？
// #1on1: 超厳密にはケースバイケースなんですけど、ほとんどの場合においては、エラーを投げる仕様に自分はする by jflute (2025/09/12)
// 特に会社のプログラミングだったらコードの統一性や可読性を考えた時に、紛らわしいのって勘違い生まれやすい。
// なぜなら、コード読む人のスキルがバラバラだし、そのコードを把握してない人が読む可能性が高い、
// 極力読み方がシンプルになるようにする。
// 一方で、設定ファイルとか、みんなが厳密な設定をしっかり書ける可能性が低いところ、かつ、読むケースも少ないところ、
// では、多少どう書いても動くようにするっていうのはよくある。
// 今と昔でちょっと感覚が違うかも、昔は動かすので精一杯、今はチームメンバー読みやすくないと。
// UIの壊れないシステムの話と、メソッドや関数の話はちょっと判断基準が変わる可能性はある。
// プログラミングの中では、正しい使い方をしたときだけちゃんと動く、ってのがメンテナンスを考えると安全。
// ユーザーの高品質の意識、セキュリティ面の意識から来るところも。
